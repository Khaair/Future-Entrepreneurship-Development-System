...
class Userrequest extends Component {
  ...
  Useractivation = async (email) => {
    await axios
      .get(
        `${URL}/sendactivationlink/${email}`,
      ...
      <div className="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
          ...
          <div className="container-fluid">
            <h1 className="mt-4">All User Request here</h1>
                    ...
                    <tr key={index}>
                      ...
                      <td data-label="Action">
                        <div style={{ display: "flex" }}>
                          <button
                            type="button"
                            onClick={() => this.Useractivation(data.email)}
                          >
                            Activate
                          </button>
                          <button
